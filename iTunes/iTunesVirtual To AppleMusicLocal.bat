...
set origen=\\WIN11VIRTUAL\SharedFolder\iTunes\Music\iTunes Media\Music
REM set destino=G:\Music
REM set destino=\\C300\Descargas\Music
set destino=C:\Users\FTW3\OneDrive\Apple\Music
...
robocopy "%origen%" "%destino%" *.m4a *.lrcs /S /XC /MT:20 /R:3 /W:1 /LOG+:robocopy.log /TEE
